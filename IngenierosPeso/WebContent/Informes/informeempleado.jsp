...
<body>
	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				ArrayList<User> usr = userdao.getTecnicos();
				int numero=1;
				...
				%>
				<tr>
				<td><%= usr.get(i).getDNI() %></td>
				<td><%= usr.get(i).getNombre() %></td>
				<td><%= usr.get(i).getApellidos() %></td>
				<td><%= usr.get(i).getNumero() %></td>
				<td><%= usr.get(i).getCorreo() %></td>
				<td><%= usr.get(i).getDepartamento() %></td>
				<tr>
				<%
				}
				%>
	...
	<div class="row text-center">
		...
		<div class="container">
			...
			<input type="button" value="Descargar" onclick="Descargar('Empleados.csv')">
