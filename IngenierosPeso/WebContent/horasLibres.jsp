...
<title>Pedir horas libres</title>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		...
		<div class="container">
			<form action=CalendarioServlet method="post">
				<label>Introduzca el motivo de las horas libre:</label> <input type="text" name="motivo" required>
				<br> <label>Introduzca el día que desea en formato yyyy-mm-dd</label> <input
					type=hidden name="dni" value=<%=dni%>> <input type="text"
					name="FechaIni" required> 
					<br><label>Introduzca la hora de inicio</label>
					<input type="text"
